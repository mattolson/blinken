...
Module.prototype.step = function( input ) {

  return input || false;
  
};

// Module can opt-out of future render cycles by calling this method.
...
// Validate options
Module.prototype.validate_options = function(new_options, use_defaults) {
  var validated = {};
...
Module.prototype.update_options = function(new_options) {
